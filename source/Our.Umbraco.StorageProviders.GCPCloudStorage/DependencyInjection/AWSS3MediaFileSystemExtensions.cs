...
using Our.Umbraco.StorageProviders.GCPCloudStorage.Imaging;
using Our.Umbraco.StorageProviders.GCPCloudStorage.IO;
using Our.Umbraco.StorageProviders.GCPCloudStorage.Services;

namespace Our.Umbraco.StorageProviders.GCPCloudStorage.DependencyInjection
{
